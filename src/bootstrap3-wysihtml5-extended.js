!function($, wysi) {
   ...
   var tpl = {
        ...
        "color": function(locale, options) {
         ...
         "imageGallery": function(locale, options){
         ...
         "imageList" : function(locale,options){
    ...
    var createBox = function(options){
         ...
         var div = bootbox.dialog(options);
         div.on("hidden.bs.show", function(e) {
   ...
   Wysihtml5.prototype = {
      ...
      initInsertImage: function(toolbar,options) {
         ...
         //get list of image
         if(options.imageListUrl !== undefined && typeof options.imageListUrl == 'string'){
            $.get(options.listUrl,function(data){
               self.data.imageList = data;
            },'json');
         }
         ...
         toolbar.find('a[data-wysihtml5-command=insertImage]').click(function() {
            var culture = options.locale || defaultOptions.locale || "en";
            var box = createBox({
               message : templates('imageGallery',locale[culture],options)
            });
         });
      },
      ...
      getBodyEditor: function(){
         return this.editor.composer.iframe.contentDocument.getElementsByTagName('body');
      }
    };
